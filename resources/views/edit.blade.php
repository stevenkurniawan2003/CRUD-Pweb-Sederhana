            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Edit Data Kopi </h4>
                ...
                <div class="card-body">
                    <form action="{{ route('update', $katalog->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jenis_kopi') is-invalid @enderror"
                                   id="jenis_kopi" name="jenis_kopi" value="{{ $katalog->jenis_kopi }}" required>
                            @error('jenis_kopi')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                   id="stok" name="stok" min="0" value="{{ $katalog->stok }}" required>
                            @error('stok')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('harga') is-invalid @enderror"
                                       id="harga" name="harga" value="{{ $katalog->harga }}" required>
                                @error('harga')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
